...
<style>
    ...
    .img-overlay-wrap_l , .img-overlay-wrap_xl {
        position: relative;
        display: inline-block;
    }
    .img-overlay-wrap_l { left: 10px; }
    .img-overlay-wrap_xl { left: 50px; }

    .img-overlay-wrap_l:after, .img-overlay-wrap_xl:after {
        content: ' ';
        display: block;
        position: absolute;
        left: 0;
    ...
    .img-overlay-wrap_l img, .img-overlay-wrap_xl img { /* <= optional, for responsiveness */
        display: block;
        padding: 70px 13px 0;
        max-width: 75%;
        height: auto;
