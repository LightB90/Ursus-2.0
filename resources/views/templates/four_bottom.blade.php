...
<style>
    ...
    .img-overlay-wrap, .img-overlay-wrap_s, .img-overlay-wrap_l, .img-overlay-wrap_xl  {
        position: relative;
        display: inline-block;
    }
    .img-overlay-wrap { left: 20px; }
    .img-overlay-wrap_s { left: 20px; }
    .img-overlay-wrap_l { left: 40px; }
    .img-overlay-wrap_xl { left: 50px; }
    .img-overlay-wrap:after, .img-overlay-wrap_s:after, .img-overlay-wrap_l:after, .img-overlay-wrap_xl:after {
        content: ' ';
        display: block;
        position: absolute;
        left: 0;
    ...
    .img-overlay-wrap_s:after { background-image: url('../../images/rama_s800.svg');}
    ...
    @media screen and (max-width: 1400px) {
        .img-overlay-wrap img { padding: 54px 14px 0; }
        .img-overlay-wrap_s img { padding: 55px 14px 0; max-width: 77%; }
    }
